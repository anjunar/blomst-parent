package com.anjunar.blomst.sqlfunction;
...
public class PostgreSQLLevenshteinFunction implements SQLFunction {
    @Override
    ...
    public String render(Type firstArgumentType, List arguments, SessionFactoryImplementor factory) throws QueryException {
        ...
        return  String.format("levenshtein(%s, %s)", column, argument);
    }
}
